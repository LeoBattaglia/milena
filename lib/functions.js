...
function getInputDataTypes(withoutArray) {
...
exports.getInputDataTypes = getInputDataTypes;
function getInputTypes() {
    return ["Choose", "Input", "MultiSelect", "Select"];
}
exports.getInputTypes = getInputTypes;
